...
/**
 * _print - This function moves a string one
...
/**
 * mul - This function multiplies a char with a
...
/**
 * check_for_digits - This function checks the
 * arguments to ensure they are digits
 *
